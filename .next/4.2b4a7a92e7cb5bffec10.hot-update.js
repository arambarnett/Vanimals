  ...
  _createClass(IndexPage, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div", {
        ...
        return e.constant;
      }).map(this.renderCall.bind(this, 'kittyCore')), "Sale Auction: ", this.props.saleAuction.address, this.props.saleAuction.abi.filter(function (e) {
        return e.constant;
      }).map(this.renderCall.bind(this, 'saleAuction')), "Siring Auction: ", this.props.siringAuction.address, this.props.siringAuction.abi.filter(function (e) {
        return e.constant;
    ...
    value: function () {
      ...
      __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee2() {
        var kittyCoreResponse, saleAuctionResponse, siringAuctionResponse;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                _context2.next = 5;
                return __WEBPACK_IMPORTED_MODULE_3__utilities_api__["a" /* default */].fetchKittyCoreSaleAuctionContract();

              case 5:
                saleAuctionResponse = _context2.sent;
                _context2.next = 8;
                return __WEBPACK_IMPORTED_MODULE_3__utilities_api__["a" /* default */].fetchKittyCoreSiringAuctionContract();

              case 8:
                siringAuctionResponse = _context2.sent;
...
//# sourceMappingURL=4.2b4a7a92e7cb5bffec10.hot-update.js.map