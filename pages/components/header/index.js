				...
				>
					<div className="container w-container">
						...
						<nav role="navigation" className="nav-menu vertical w-nav-menu">
							...
							<a href="/about" className="dropdown vertical w-nav-link" style={{ maxWidth: 1170 }}>
								About
							</a>
							<a
								href="/marketplace"
							...
							<a href="/store" className="dropdown vertical w-nav-link" style={{ maxWidth: 1170 }}>
								Store
							</a>
							<a
								href="/my-account"
							...
							<a href="/faq" className="dropdown vertical w-nav-link" style={{ maxWidth: 1170 }}>
								faq
							</a>
							<a
								href="/settings"
