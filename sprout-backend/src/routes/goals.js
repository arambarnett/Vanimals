...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { userId, title, description, type, category, subcategory, targetValue, unit, frequency, startDate, endDate, experienceReward, foodReward, integrationId, } = req.body;
        ...
        let sprout = yield prisma_1.prisma.sprout.findFirst({
            where: {
                userId,
        ...
        if (!sprout) {
            try {
                ...
                if (user && user.walletAddress) {
                    ...
                    const txHash = yield aptosService.mintSproutNFT(user.walletAddress, {
                        name: sproutName,
                    ...
                    sprout = yield prisma_1.prisma.sprout.create({
                        data: {
                            userId,
        ...
        if (goalCategory === 'fitness' && !integrationId) {
            const stravaIntegration = yield prisma_1.prisma.integration.findUnique({
                where: {
                    userId_provider: {
                        userId,
                        provider: 'strava',
        ...
        const goal = yield prisma_1.prisma.goal.create({
            data: {
                userId,
                sproutId: sprout.id,
                title,
...
router.get('/user/:userId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const goals = yield prisma_1.prisma.goal.findMany({
            where: Object.assign(Object.assign(Object.assign({ userId }, (type && { category: type })), (isActive !== undefined && { isActive: isActive === 'true' })), (isCompleted !== undefined && { isCompleted: isCompleted === 'true' })),
            include: {
                integration: true,
                activities: {
 ...
 */
router.get('/:goalId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Calculate progress
        const progress = yield goalTrackingService.calculateGoalProgress(goalId);
        res.json(Object.assign(Object.assign({}, goal), { progress }));
    }
    catch (error) {
 ...
 * Update a goal
 */
router.put('/:goalId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { goalId } = req.params;
        const { title, description, targetValue, currentValue, isActive, endDate, } = req.body;
        const goal = yield prisma_1.prisma.goal.update({
            where: { id: goalId },
            data: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (title && { title })), (description !== undefined && { description })), (targetValue !== undefined && { targetValue: parseFloat(targetValue) })), (currentValue !== undefined && { currentValue: parseFloat(currentValue) })), (isActive !== undefined && { isActive })), (endDate !== undefined && { endDate: endDate ? new Date(endDate) : null })),
        });
        res.json(goal);
    }
    catch (error) {
 ...
 * Delete a goal
 */
router.delete('/:goalId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { goalId } = req.params;
        yield prisma_1.prisma.goal.delete({
            where: { id: goalId },
        });
 ...
 */
router.post('/:goalId/progress', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { goalId } = req.params;
        ...
        const result = yield goalTrackingService.processActivity(goal.userId, {
            type: goal.type,
 ...
 */
router.get('/:goalId/analytics', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { goalId } = req.params;
        const goal = yield prisma_1.prisma.goal.findUnique({
            where: { id: goalId },
 ...
 */
router.get('/user/:userId/recommendations', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { userId } = req.params;
        const integrations = yield prisma_1.prisma.integration.findMany({
