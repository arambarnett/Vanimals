 ...
 */
router.post('/sync-activities', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Fetch activities
        const activitiesResponse = yield fetch('https://www.strava.com/api/v3/athlete/activities?per_page=30', {
            headers: {
 ...
 */
router.get('/athlete-stats/:userId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const athlete = yield athleteResponse.json();
        // Get athlete stats (YTD totals)
        const statsResponse = yield fetch(`https://www.strava.com/api/v3/athletes/${athlete.id}/stats`, {
            headers: {
                'Authorization': `Bearer ${integration.accessToken}`,
            },
        });
        const stats = yield statsResponse.json();
        // Get recent activities (last 30 days)
        const thirtyDaysAgo = Math.floor(Date.now() / 1000) - (30 * 24 * 60 * 60);
        const activitiesResponse = yield fetch(`https://www.strava.com/api/v3/athlete/activities?after=${thirtyDaysAgo}&per_page=50`, {
            headers: {
                'Authorization': `Bearer ${integration.accessToken}`,
            },
        });
        const recentActivities = yield activitiesResponse.json();
        ...
        for (const activity of recentActivities) {
            ...
            if (type.includes('run'))
                category = 'running';
            else if (type.includes('ride') || type.includes('cycle'))
                category = 'cycling';
        ...
        // Running suggestions
        if (((_a = stats.ytd_run_totals) === null || _a === void 0 ? void 0 : _a.count) > 0) {
            const avgWeeklyMiles = (((_b = stats.recent_run_totals) === null || _b === void 0 ? void 0 : _b.distance) || 0) / 1609.34 / 4; // Last 4 weeks average
            ...
            goalSuggestions.push({
                ...
                recentStats: {
                    last30Days: {
                        count: ((_c = activityBreakdown.running) === null || _c === void 0 ? void 0 : _c.count) || 0,
                        distance: (((_d = activityBreakdown.running) === null || _d === void 0 ? void 0 : _d.distance) || 0).toFixed(1),
                        time: (((_e = activityBreakdown.running) === null || _e === void 0 ? void 0 : _e.time) || 0).toFixed(0),
                    },
                    ytd: {
                        count: ((_f = stats.ytd_run_totals) === null || _f === void 0 ? void 0 : _f.count) || 0,
                        distance: ((((_g = stats.ytd_run_totals) === null || _g === void 0 ? void 0 : _g.distance) || 0) / 1609.34).toFixed(1),
                        elevation: ((((_h = stats.ytd_run_totals) === null || _h === void 0 ? void 0 : _h.elevation_gain) || 0) * 3.28084).toFixed(0), // meters to feet
                    },
                },
            });
        }
        // Cycling suggestions
        if (((_j = stats.ytd_ride_totals) === null || _j === void 0 ? void 0 : _j.count) > 0) {
            const avgWeeklyMiles = (((_k = stats.recent_ride_totals) === null || _k === void 0 ? void 0 : _k.distance) || 0) / 1609.34 / 4;
            ...
            goalSuggestions.push({
                ...
                recentStats: {
                    last30Days: {
                        count: ((_l = activityBreakdown.cycling) === null || _l === void 0 ? void 0 : _l.count) || 0,
                        distance: (((_m = activityBreakdown.cycling) === null || _m === void 0 ? void 0 : _m.distance) || 0).toFixed(1),
                        time: (((_o = activityBreakdown.cycling) === null || _o === void 0 ? void 0 : _o.time) || 0).toFixed(0),
                    },
                    ytd: {
                        count: ((_p = stats.ytd_ride_totals) === null || _p === void 0 ? void 0 : _p.count) || 0,
                        distance: ((((_q = stats.ytd_ride_totals) === null || _q === void 0 ? void 0 : _q.distance) || 0) / 1609.34).toFixed(1),
                        elevation: ((((_r = stats.ytd_ride_totals) === null || _r === void 0 ? void 0 : _r.elevation_gain) || 0) * 3.28084).toFixed(0),
                    },
                },
            });
        }
        // Swimming suggestions
        if (((_s = stats.ytd_swim_totals) === null || _s === void 0 ? void 0 : _s.count) > 0) {
            goalSuggestions.push({
                category: 'swimming',
                activityType: 'Swim',
                icon: '🏊',
                ...
                recentStats: {
                    last30Days: {
                        count: ((_t = activityBreakdown.swimming) === null || _t === void 0 ? void 0 : _t.count) || 0,
                        distance: (((_u = activityBreakdown.swimming) === null || _u === void 0 ? void 0 : _u.distance) || 0).toFixed(1),
                        time: (((_v = activityBreakdown.swimming) === null || _v === void 0 ? void 0 : _v.time) || 0).toFixed(0),
                    },
                    ytd: {
                        count: ((_w = stats.ytd_swim_totals) === null || _w === void 0 ? void 0 : _w.count) || 0,
                        distance: ((((_x = stats.ytd_swim_totals) === null || _x === void 0 ? void 0 : _x.distance) || 0) / 1000).toFixed(1), // meters to km
                    },
                },
            });
        }
